...
from latent_diffusion_trainer import LatentDiffusionTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default=os.path.join("../config", "ffhq_latent_diffusion.yml"))
    # Automatically detect run_path/checkpoints/latest.pt to decide whether
    # to restore or
    # to train from scratch using config.yml above.
    parser.add_argument('--run_path', type=str, default=os.path.join("../runs", "ffhq_latent_diffusion"))
